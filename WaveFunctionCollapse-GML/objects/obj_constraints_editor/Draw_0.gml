...
if (instance_exists(cur_edited_tile)) {
	if (tile_mode == EDITOR_TILE_MODE.FINAL) {
		...
		draw_text(944 + 16, 128 - 16, side_array[| SIDE.TOP]);
		draw_text(944 + 16, 128 + 48, side_array[| SIDE.BOTTOM]);
		...
		draw_text(944 - 16, 128 + 16, side_array[| SIDE.LEFT]);
		draw_text(944 - 16, 272 + 16, cur_edited_tile.possible_neighbours[SIDE.LEFT]);
		draw_set_halign(fa_left);
		draw_text(944 + 48, 128 + 16, side_array[| SIDE.RIGHT]);
